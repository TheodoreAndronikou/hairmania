/* =============================================================
   ΚΕΝΤΡΙΚΕΣ ΡΥΘΜΙΣΕΙΣ ΤΟΥ SITE
   Αυτό είναι το ΜΟΝΟ αρχείο που χρειάζεται να αλλάξεις μετά
   την εγκατάσταση. Οδηγίες: docs/ΟΔΗΓΙΕΣ-ΕΓΚΑΤΑΣΤΑΣΗΣ.md

   ΓΙΑ ΝΕΟ ΚΑΤΑΣΤΗΜΑ: άλλαξε τα παρακάτω και τρέξε
       node rebrand.mjs
   ώστε να ξαναγραφτούν οι τίτλοι σελίδων, τα og: (προεπισκόπηση
   link σε WhatsApp/Facebook) και τα δομημένα δεδομένα του Google.
   Αυτά ΔΕΝ γίνονται δυναμικά με JavaScript επίτηδες: τα διαβάζουν
   crawlers που δεν τρέχουν JS. Το publish.mjs το τρέχει μόνο του.
   ============================================================= */
...
window.CONFIG = {
  ...
  business: {
    ...
    /* Το λογότυπο στην μπάρα γράφεται σε δύο γραμμές: μεγάλη + μικρή.
       Αν το όνομα είναι μονοκόμματο, άσε το brandSub κενό ('') και
       θα δείξει μόνο τη μία γραμμή. */
    brandTop: 'HAIR MANIA',
    brandSub: 'VALKANIS',
    ...
    address: {
      ...
      city: 'Γιαννιτσά',
      /* Το ίδιο με λατινικούς χαρακτήρες, για τα αγγλικά κείμενα. */
      cityEn: 'Giannitsa',
      /* Η πόλη ΜΕ το άρθρο, όπως μπαίνει μέσα σε πρόταση:
         'στα Γιαννιτσά', 'στη Θεσσαλονίκη', 'στην Αθήνα', 'στο Κιλκίς'.
         Τα ελληνικά δεν κλίνονται αυτόματα — γι' αυτό γράφεται εδώ. */
      cityIn: 'στα Γιαννιτσά',
      postcode: '58100',
      country: 'GR'
    },

    /* Ενδεικτικό εύρος τιμών για τα δομημένα δεδομένα του Google. */
    priceRange: '€€',
